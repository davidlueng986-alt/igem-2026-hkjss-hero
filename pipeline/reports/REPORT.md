...
## 0. MCP + skills
- Blender MCP: live (addon 1.5, protocol 4).
- GitHub MCP: live as `davidlueng986-alt`. Repo: https://github.com/davidlueng986-alt/igem-2026-hkjss-hero
- blender-skills: 94 skills at `.claude/skills/` from https://github.com/arjun988/blender-skills
...
| 6 | lower third < 8% luma | **FAIL** | mean **0.136** after ground spec 0 (was 0.47). Target < 0.08. |
| 7 | grazing rim | **PASS** | left-lower rim |
| 8 | keys not mirrored | **PASS** | L 400 W / R 260 W warmer lower |
| 9–10 | hue / bump | **HOLD** | 8 spp noisy; nodes correct |
...
**Verdict: NO-SHIP.** Geometry has shipped. Sequences remain blocked. Next one-variable: HDRI Z-rot or KEY-L power, not a second ground knob.
...
| `lookdev-iter4.png` / `4b` / `4c` | 200×280 8 spp Cycles |
| sequences | 0 / 48+8+72 |
...
## 8. Known issues
1. Lower-third luma 0.136 vs < 0.08 — remaining foot is KEY/HDRI, not ground spec.
